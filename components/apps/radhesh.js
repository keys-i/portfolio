    ...
    return (
      <>
        ...
        <div
          ...
          onFocus={this.changeScreen}
          className={
            (this.state.active_screen === "portfolio"
              ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95"
              : " hover:bg-gray-50 hover:bg-opacity-5 ") +
            " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"
          }
  ...
  return (
    <>
      <div className="w-20 md:w-28 my-4 bg-white rounded-full">
        <img className="w-full" src="./images/logos/profile.png" alt="Rad's portrait" />
      </div>
      ...
      <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
        <li className=" list-pc">
          I'm a <span className=" font-medium">Undergraduate Student</span> currently pursuing
          Computer Science. I am a contributor at{" "}
          <u className=" cursor-pointer ">
            {" "}
            <a href="https://en.wikipedia.org/wiki/AlmaLinux" target={"_blank"}>
              AlmaLinux
            </a>{" "}
          </u>
          , and now I'm looking for some internship opportunities! ( Hit me up{" "}
          <a className="text-underline" href="mailto:radhesh036916@gmail.com">
            <u>@radhesh036916@gmail.com</u>
          </a>{" "}
          :) )
        </li>
        <li className=" mt-3 list-building">
          {" "}
          I enjoy building awesome things that use my creativity.
        </li>
        <li className=" mt-3 list-time">
          {" "}
          When I am not coding my next project, I like to spend my time reading books, learning a
          new language or watching{" "}
          <a href="https://www.youtube.com/@RasOrgUk" target="_blank" rel="noreferrer">
            {" "}
            Royal Astronomical Society's lectures.
          </a>
        </li>
        <li className=" mt-3 list-star">
          {" "}
          And I also have interest in Languages, Physics, Chemistry ,and Mathematics!
        </li>
      </ul>
    </>
  );
        ...
        <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
          <div>
            ...
            <strong className="text-ubt-gedit-orange">
              operating system development, C and RISC-V!
            </strong>
          </div>
        </li>
        <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
...
function Projects() {
  const project_list = [
    ...
    },
    {
      ...
      description: ["A simple OS which shows the implementation of Kernel and Bootloader"],
      domains: ["Assembly", "Shell", "C"],
    },
    {
      name: "LearnerOS",
      ...
      description: ["A small hello world - like OS usng C , Shell and assembly code."],
      domains: ["Assembly", "Shell", "C"],
    },
    {
      ...
      description: ["A scraper to scrap off images"],
      domains: ["python"],
    },
    {
      name: "code-server",
      ...
      description: ["A self-hostable server of coding IDE on my raspberry pi using docker."],
    ...
    },
    {
      ...
      description: ["A digital and analog clock to used a minimalistic screensaver."],
      domains: ["Python", "tk"],
    },
    {
      name: "Panicking",
      ...
      description: ["A module to make kernel panic."],
      domains: ["C", "CMake"],
    },
    {
      name: "hello_world",
      ...
      description: ['A basic "Hello World" kernel module.'],
      domains: ["C", "CMake"],
    },
    {
      name: "Tic Tac Toe",
...
function Resume() {
  return (
    <iframe
      ...
      src="./files/Radhesh-Goel-Resume.pdf"
      title="Radhesh Goel resume"
      frameBorder="0"
    ></iframe>
  );
}
